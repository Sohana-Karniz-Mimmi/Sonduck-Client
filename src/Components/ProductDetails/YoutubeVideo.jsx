...
import playButton from "../../assets/images/buttonplay.svg";
  ...
  return (
    <div className="flex gap-6 mt-10">
          ...
          <div className="fixed inset-0 flex items-center justify-center bg-white bg-opacity-80 z-50">
            <div className="relative bg-black px-2 rounded shadow-lg">
              <button
                ...
                className="absolute -top-8 right-[5px] text-3xl font-bold"
              >
      ...
      <div className="md:w-[357px] flex-1">
        <div
          className=" p-5 border rounded-[10px]"
          style={{
            boxShadow:
        ...
        >
          <div className="flex justify-between items-center">
            ...
            <div>
              <span className="mr-2 text-right text-[32px] font-semibold text-primary font-inter">
                $48
              </span>
              <span className="text-right text-[24px] font-medium text-slate-600 font-inter">
                $32
              </span>
            </div>
          </div>
          <div className="py-6 border-b">
            <button className="mb-3 w-full btn text-primary bg-transparent border-primary hover:bg-transparent hover:border-primary">
              Add to cart
            </button>
            <button className="w-full btn text-white bg-primary border-primary hover:bg-primary hover:border-primary">
              Buy now
            </button>
          </div>
          <div className="mt-6">
            <div className="pb-4 flex justify-between items-center">
              ...
              <div>
                <span className="text-right text-[16px] leading-[24px] font-normal text-[#475569] font-inter">
                  62.92 MB
                </span>
              </div>
            </div>
        ...
        <div className="space-y-4 p-[32px] bg-[rgba(255,104,154,0.2)] mt-6">
          ...
          <p className="text-sm font-bold text-gray-600 font-plus">
            Unlock this theme and get unlimited access to over 1000+ Premium
            templates.
          </p>
          <p className="text-sm font-semibold text-primary font-plus">
            Go Unlimited now
          </p>
        </div>
      </div>
