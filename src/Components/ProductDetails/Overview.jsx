const Overview = () => {
    return (
        <>
            ...
            <div className="my-6 md:w-[800px] xl:[1000px]">
                <div>
                    <h2 className="text-[24px] mb-4 leading-[40px] font-medium text-[#171717] font-inter">Full Customization</h2>
                    <p className="text-base text-[#171717] font-inter">
