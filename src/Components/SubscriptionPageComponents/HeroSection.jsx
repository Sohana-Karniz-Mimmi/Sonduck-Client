      ...
      >
        <div className="max-w-[1200px] w-full mx-auto">
          ...
          <div className="pt-32 pb-64">
            <h2 className="title text-center text-4xl lg:text-[64px] font-semibold mb-24 p-2">
              Subscription
            </h2>
      ...
      <div className="px-5">
        <div className="max-w-[1200px]  w-full mx-auto flex flex-col md:flex-row justify-between items-center gap-5 p-5 lg:p-10 border shadow-slate-400 bg-white shadow-lg rounded-2xl md:-mt-60 mb-24">
          <div className="w-full">
            <h4 className="text-xl font-semibold text-gray-900 text-center mb-5">What is MotionDuck?</h4>
            <iframe
          ...
          <div className="w-full">
            <h4 className="text-xl font-semibold text-gray-900 text-center mb-5">Subscription Walkthrough</h4>
            <iframe
              className="w-full rounded-2xl"
              height="315"
