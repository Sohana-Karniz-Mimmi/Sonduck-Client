  ...
  return (
    <div className="py-20 px-32 bg-[#dddddd] flex flex-col items-center gap-14">
      <div className="grid grid-cols-2 gap-11 w-full">
        <h1 className="w-[577px] gro text-5xl text-black font-semibold">
          Discover What Our Community Is Saying
        </h1>
        <p className="w-[577px] gro text-xl text-black">
        ...
        >
          <SwiperSlide>
            <div className="p-6 rounded-lg bg-white flex flex-col items-start gap-1">
              ...
              <p className="gro ">
                Sonduck has transformed my approach to learning. The diverse
          ...
          <SwiperSlide>
            <div className="p-6 rounded-lg bg-white flex flex-col items-start gap-1">
              ...
              <p className="gro ">
                I've tried several online learning platforms, and Sonduck stands
                out for its vibrant community and the variety of courses
          ...
          <SwiperSlide>
            <div className="p-6 rounded-lg bg-white flex flex-col items-start gap-1">
              ...
              <p className="gro ">
                As a creator, Sonduck has been a game-changer for me. The Course
                Editor is user-friendly, and the support from the community is
                incredible. It's fulfilling to see my courses making a positive
                impact on learners globally.
              </p>
            </div>
          </SwiperSlide>
